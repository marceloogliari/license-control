defmodule Licenca.Accounts do
  ...
  alias Licenca.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Licenca.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Licenca.Accounts.User.password_changeset/3` for a list of supported options.
